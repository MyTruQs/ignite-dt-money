...
import { CloseButton, Content, Overlay, TransactionType, TransactionTypeButon } from "./styles";
...
export function NewTransactionModal() {
    ...
    async function handleCreateNewTransactionFormInputs(data: NewTransactionFormInputs) {
